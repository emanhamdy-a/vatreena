...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 17, 2020 at 06:00 AM
...
CREATE TABLE `prdct` (
  ...
  `color` enum('black','violet','White','Orange','Brown','Fuchsia','Blue','Yellow','Red','Green') COLLATE utf8_unicode_ci NOT NULL,
  `size` enum('s','m','l','xl','xxl','xxxl','xxxxl') COLLATE utf8_unicode_ci NOT NULL,
  `cat_id` smallint(3) NOT NULL,
  `sub_cat` smallint(3) NOT NULL,
  `img` varchar(225) COLLATE utf8_unicode_ci NOT NULL,
  `userid` int(9) NOT NULL,
  `adrs` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `phonnu` varchar(11) COLLATE utf8_unicode_ci DEFAULT NULL,
  `storenm` varchar(55) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `prdct` (`id`, `prdctnm`, `dscrptn`, `pric`, `stock`, `color`, `size`, `cat_id`, `sub_cat`, `img`, `userid`, `adrs`, `phonnu`, `storenm`) VALUES
(1, 'Ø¬Ø§ÙƒØª', 'Ø¬Ø§ÙƒØª ÙƒØ§Ø¬ÙˆØ§Ù„       ', 435, 34, 'Blue', 'xxxl', 2, 23, 'img/userimg/9609075131454126648.jpg', 1, 'ali hamza strreet', '01090925920', 'eman_store'),
(2, 'Ø¬Ø§ÙƒØª', 'Ø¬Ø§ÙƒØª ÙƒØ§Ø¬ÙˆØ§Ù„    ', 434, 3432, 'Green', 'l', 2, 22, 'img/userimg/1365360986640042560.jpg', 1, 'ali hamza strreet', '01090925920', 'eman_store'),
(3, 'Ø³Ù„Ù„', 'Ø³Ø¨Ø³Ø«ÙŠÙ', 434, 54, 'Fuchsia', 'm', 1, 5, 'img/userimg/1025529518161859582.jpg', 1, 'ali hamza strreet', '01090925920', 'eman_store'),
(4, 'srtu', 'fg dsf sedrd serf zsde se ', 1212, 122, 'Fuchsia', 'l', 1, 6, 'img/userimg/1095761766875814706.jpeg', 1, 'ali hamza strreet', '01090925920', 'eman_store');
...
CREATE TABLE `users` (
  `id` int(11) NOT NULL,
  `usernm` varchar(60) COLLATE utf8_unicode_ci NOT NULL,
  `pasword` varchar(60) COLLATE utf8_unicode_ci NOT NULL,
  `phonnu` varchar(11) COLLATE utf8_unicode_ci NOT NULL,
  `email` varchar(50) CHARACTER SET latin1 NOT NULL,
  `storenm` varchar(60) COLLATE utf8_unicode_ci DEFAULT NULL,
  `adrs` text COLLATE utf8_unicode_ci,
  `gvrn_id` tinyint(2) DEFAULT NULL,
  `cty_id` tinyint(2) DEFAULT NULL,
  `usr_typ` enum('merchant') CHARACTER SET latin1 NOT NULL DEFAULT 'merchant'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `users` (`id`, `usernm`, `pasword`, `phonnu`, `email`, `storenm`, `adrs`, `gvrn_id`, `cty_id`, `usr_typ`) VALUES
(1, 'eman', 'hghldvhgsud]1A', '01090925920', 'eman@gmail.com', 'eman_store', 'ali hamza strreet', 2, 21, 'merchant');
...
CREATE TABLE `visitor` (
  `id` int(11) NOT NULL,
  `usernm` varchar(60) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `phonnu` int(11) NOT NULL,
  `pasword` int(60) NOT NULL,
  `email` int(25) NOT NULL,
  `usr_typ` enum('byer') NOT NULL DEFAULT 'byer',
  `kind` enum('female','male') NOT NULL DEFAULT 'female'
...
INSERT INTO `visitor` (`id`, `usernm`, `phonnu`, `pasword`, `email`, `usr_typ`, `kind`) VALUES
(1, 'emann', 1090925921, 0, 0, 'byer', 'female');
...
--
ALTER TABLE `favorit`
  ADD CONSTRAINT `favorit_ibfk_1` FOREIGN KEY (`userid`) REFERENCES `visitor` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
ALTER TABLE `prdct`
  ...
  ADD CONSTRAINT `prdct_ibfk_3` FOREIGN KEY (`userid`) REFERENCES `users` (`id`);
